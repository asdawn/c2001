...
The old [www.c2001.net](www.c2001.net) website was created on weebly, but it is down now. A lot of pages and experimental data are lost. However the net.c2001 library has a mirror here. In the next few years I will keep this domain and redirect it to a [github repository](https://github.com/asdawn/c2001).
